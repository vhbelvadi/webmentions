<div class="bg-white dark:bg-gray-850 rounded-xl ring ring-gray-200 dark:ring-x-0 dark:ring-b-0 dark:ring-gray-700/80 shadow-ui-md @container/widget min-h-54" data-ui-card data-inset="true">
    ...
    @if ( $mentions )
        <table class="w-full text-sm">
            <tbody tabindex="0" class="block py-2 w-full">
                @foreach ($mentions as $mention)
                    <tr class="grid sortable-row w-full">
                        <td>
